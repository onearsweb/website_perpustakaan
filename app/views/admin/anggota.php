          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header d-flex align-items-center justify-content-between">
                <h4>Data Anggota</h4>
                <a href="<?= baseURL; ?>/anggota/tambah_anggota">
                  <button type="button" class="btn btn-primary">
                    <i class="menu-icon bx bxs-user-plus"></i> Tambah Anggota
                  </button>
                </a>
              </div>
                ...
                <table class="table table-hover text-center">
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>Reddis Angel</td>
                      <td>
                        <span class="badge bg-label-danger me-1">Perempuan</span>
                      </td>
                      ...
                      <td>
                        <div class="container-act">
                          <!-- Edit -->
                          <a href="<?= baseURL; ?>/anggota/edit_anggota">
                          ...
                          <a href="#">
                            ...
                            <button type="button" class="btn btn-icon btn-danger f-left mr-10" onclick="hapusData()">
                    ...
                    <tr>
                      ...
                      <td>Just Jay</td>
                      <td>
                        <span class="badge bg-label-secondary me-1">Laki - Laki</span>
                      </td>
                      <td>Jl. Jendral Sudirman No. 2</td>
                      <td>089934234</td>
                      <td>
                        <div class="container-act">
                          <!-- Edit -->
                    ...
                    <tr>
                      ...
                      <td>Jl. Jendral Sudirman No. 3</td>
                      <td>089934234</td>
                      <td>
                        <div class="container-act">
                          <!-- Edit -->
                    ...
                    <tr>
                      ...
                      <td>Jl. Jendral Sudirman No. 4</td>
                      <td>089934234</td>
                      <td>
                        <div class="container-act">
                          <!-- Edit -->
                    ...
                    <tr>
                      ...
                      <td>Jl. Jendral Sudirman No. 5</td>
                      <td>089934234</td>
                      <td>
                        <div class="container-act">
                          <!-- Edit -->
