...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Buku/</span> Tambah Buku
            </h4>
                    ...
                    <form>
                      ...
                      <div class="row justify-content-end">
                        <div class="col-sm-10 text-end">
                          ...
                          <button type="button" class="btn btn-primary" onclick="simpanData()">Simpan
                          </button>
                        </div>
                      </div>
                    </form>
  ...
  <script>
    function simpanData() {
      ...
      alertDiv.className = 'alert alert-success alert-dismissible fixed-top text-center';
      alertDiv.role = 'alert';
