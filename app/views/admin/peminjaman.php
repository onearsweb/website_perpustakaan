        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Aktivitas /</span> Data
              Peminjaman
            </h4>
                ...
                <table class="table table-hover text-center">
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>1</td>
                      <td>
                        <span class="badge bg-label-primary me-1">Dikembalikan</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>1</td>
                      <td>
                        <span class="badge bg-label-success me-1">Dipinjam</span>
                      </td>
