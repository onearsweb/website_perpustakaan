        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Users /Anggota/</span> Tambah Anggota
            </h4>
              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Isi Data Anggota</h5>
                  ...
                  <div class="card-body">
                    <form>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bxs-flame"></i></span>
                            <input type="text" class="form-control" id="nim" name="nim" placeholder="17223016" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user-circle"></i></span>
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Reddis Angel" />
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- Jenis Kelamin -->
                      <div class="row mb-3">
                        <label class="col-sm-2 mt-2  form-label" for="basic-icon-default-phone">Jenis Kelamin</label>
                        <div class="col-sm-10">
                      ...
                      <!-- No Telepon -->
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-icon-default-email">No Telepon</label>
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span class="input-group-text"><i class="bx bx-phone"></i></span>
                            <input type="number" id="telepon" name="telepon" class="form-control" placeholder="0882328216" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row mb-5">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <textarea id="alamat" name="alamat" class="form-control" placeholder="Jl. Raya Ciputat No. 1 Ciputat"></textarea>
                          </div>
                        </div>
                      </div>
