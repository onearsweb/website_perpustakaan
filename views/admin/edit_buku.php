<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="../../style/assets/" data-template="vertical-menu-template-free">
...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Buku/</span> Ubah Data Buku
            </h4>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form>
                      <!-- Id Buku -->
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">ID Buku</label>
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i class='bx bx-edit-alt'></i></span>
                            <input type="number" class="form-control" id="id-buku" name="id-buku" placeholder="001" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="judul-buku" name="judul-buku" placeholder="Habislah Gelap Terbitlah Terang" />
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- Deskripsi Buku -->
                      <div class="row mb-3">
                        <label class="col-sm-2 mt-4 form-label" for="basic-icon-default-message">Deskripsi Buku</label>
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-message2" class="input-group-text"><i class='bx bxs-book-reader'></i></span>
                            <textarea id="deskripsi-buku" name="deskipsi-buku" class="form-control" placeholder="Pada Zaman Dahulu..."></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- Rak Buku -->
                      <div class="row mb-3">
                        <label class="col-sm-2 mt-2 form-label" for="basic-icon-default-phone">Rak Buku</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <select class="form-select" id="rak-buku" name="rak-buku">
                      ...
                      <!-- Stok Buku -->
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-icon-default-email">Stok Buku</label>
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span class="input-group-text"><i class="bx bxs-flame"></i></span>
                            <input type="number" id="stok-buku" name="stok-buku" class="form-control" placeholder="1000" />
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- Status Buku -->
                      <div class="row mb-3">
                        <label class="col-sm-2 mt-2 form-label" for="basic-icon-default-phone">Status Buku</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <select class="form-select" id="status-buku" name="status-buku">
                      ...
                      <div class="row justify-content-end">
                        <div class="col-sm-10 text-end">
                          ...
                          <button type="button" class="btn btn-info" onclick="ubahData()"> Ubah
                          </button>
                        </div>
                      </div>
                    </form>
  ...
  <script>
    function ubahData() {
      ...
      alertDiv.className = 'alert alert-info alert-dismissible fixed-top text-center';
      alertDiv.role = 'alert';
      ...
      alertDiv.innerHTML = `
        ...
        `;
      // Tambahkan alert ke dalam alertContainer
