...
<head>
  ...
  <!-- Page CSS -->
  <link rel="stylesheet" href="../../style/assets/css/style_admin.css" />
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
            ...
            <div class="card">
              <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="tambah_buku.php">
                  <button type="button" class="btn btn-primary"><i class='menu-icon bx bxs-book-add'></i> Tambah Buku</button>
                </a>
              </div>
                ...
                <table class="table table-hover text-center">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Id Buku</th>
                      <th class="judul-buku">Judul Buku</th>
                      <th>Author</th>
                      <th>Kategori</th>
                      <th>Deskripsi</th>
                      <th>Cover Buku</th>
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>B005</td>
                      <td class="judul-buku">All These Wonders: True Stories About Facing...</td>
                      <td>Rini</td>
                      <td>Fantasi</td>
                      <td class="deskripsi-buku">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, ex.</td>
                      <td><img class="sampul-buku" src="../../style/assets/img/book/1.png" alt=""></td>
                      <td>A</td>
                      <td>30</td>
                      <td>
                        <span class="badge bg-label-primary me-1">Tersedia</span>
                      </td>
                      <td>
                        <!-- Edit -->
                        <div class="container-act">
                          <a href="edit_buku.php">
                          ...
                          <a href="#">
                            ...
                            <button type="button" class="btn btn-icon btn-danger" onclick="hapusData()">
                    ...
                    <tr>
                      ...
                      <td>B004</td>
                      <td>The Handbook of Forgotten Skills</td>
                      <td>Rika</td>
                      <td>Fantasi</td>
                      ...
                      <td><img class="sampul-buku" src="../../style/assets/img/book/2.png" alt=""></td>
                      <td>A</td>
                      <td>20</td>
                      <td>
                        <span class="badge bg-label-primary me-1">Tersedia</span>
                    ...
                    <tr>
                      ...
                      <td>B003</td>
                      <td class="judul-buku">An Unofficial Guide to the World of Studio Ghibli</td>
                      <td>Riza</td>
                      <td>Anak - Anak</td>
                      ...
                      <td><img class="sampul-buku" src="../../style/assets/img/book/3.png" alt=""></td>
                      <td>C</td>
                      <td>0</td>
                      <td>
                        <span class="badge bg-label-danger me-1">Kosong</span>
                      </td>
                      <td>
                        <!-- Edit -->
                        <div class="container-act">
                    ...
                    <tr>
                      ...
                      <td>B001</td>
                      <td>essential 20s: 20 essential items for every room</td>
                      <td>Adi</td>
                      ...
                      <td><img class="sampul-buku" src="../../style/assets/img/book/4.png" alt=""></td>
                      <td>A</td>
                      <td>30</td>
                      <td>
                        <span class="badge bg-label-primary me-1">Tersedia</span>
      ...
      <!-- Vendors JS -->
      <script src="../../style/assets/vendor/libs/masonry/masonry.js"></script>
      ...
      <script>
        function hapusData() {
          ...
          alertDiv.className = 'alert alert-danger alert-dismissible fixed-top';
          alertDiv.role = 'alert';
          alertDiv.style.zIndex = 5000;
          alertDiv.innerHTML = `
        <strong>Yakin!</strong> Ingin menghapus data ini?
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        <button type="submit" class="btn btn-xs btn-outline-danger" style="margin-left: 7px;">Ya</button>
      `;
